...
namespace MySchool.Controllers
{
    public class Students1Controller : Controller
    {
        ...
        public Students1Controller(MySchoolContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("FirstName,LastName,EnrollmentDate,Id")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> EditPost(int id, [Bind("FirstName,LastName,EnrollmentDate,Id")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
